...
public class Utils {
	...
	public static String getTokenId(String value){
		return EncodeUtils.md5(value+System.currentTimeMillis());
	}
    ...
    public static Date parseDateTime(final String dateTime) throws ParseException {
        String format = "yyyy-MM-dd HH:mm:ss";
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(format);
    ...
    public static String formatDateTime(final String dateTime) throws ParseException {
        String format = "yyyy-MM-dd HH:mm:ss";
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(format);
        return simpleDateFormat.format(parseDateTime(dateTime));
    }

    public static Date parseDateTime(final String dateTime, final String format) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(format);
        Date date = simpleDateFormat.parse(dateTime);
        return date;
    }
